...
<body style="margin-top: 30px; background-color: #FFFFFF;">
    ...
    <div class = "container" style= "width: 50%; padding: 30px;">
        <ul class="list-group">
            ...
            <li class="list-group-item" type="" style="font-size: 30px; color: #FFFFFF;"><a style="color: 	#0000FF;" href="laporan_tanggal.php">laporan_tanggal</a></li>
            <li class="list-group-item" style="font-size: 30px; color: #FFFFFF;"><a style="color: 	#0000FF;" href="laporan_periksa_tanggal.php">laporan_periksa_tanggal</a></li>
            <li class="list-group-item" style="font-size: 30px; color: #FFFFFF;"><a style="color: 	#0000FF;" href="laporan_rusak.php">laporan rusak</a></li>
        </ul>
    </div>
